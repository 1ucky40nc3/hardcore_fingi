 ...
 */
const unsigned long DELAY_AFTER_SERIAL_INITIALIZED = 2000;

/**
 * @brief The pin where the Neo Pixel LED is connected to.
 */
const unsigned int LED_PIN = 38;

/**
 * @brief The number of Neo Pixel LEDs in the setup.
 */
const unsigned int NUM_LEDS = 1;